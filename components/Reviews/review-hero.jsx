...
export default function ReviewHero() {
  return (
    <div
      className='bg-cover bg-center bg-no-repeat h-[293px] md:mt-[44px] max-md:h-[190px] max-md:px-4 '
      style={{ background: 'linear-gradient(360deg, #272727 0%, rgba(39, 39, 39, 0) 100%), url(/rewievhero.png)' }}
    >
