...
export default function CantactHero() {
  return (
    <div className='bg-[url(/kantacthero.png)] bg-cover bg-center bg-no-repeat  h-[293px] mt-[44px]   '>
      <div className='pt-[128px] max-sm:mr-4 max-sm:ml-4 max-w-[1340px] m-auto'>
        ...
        <h1 className='font-normal text-[64px] max-sm:text-[32px] leading-[100%] tracking-[-0.04em] mt-[32px] text-[#FFF]'>Контакты и расположение офиса</h1>
      </div>
    </div>
  )
}
