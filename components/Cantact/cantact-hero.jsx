  ...
  return (
    ...
    >
      <div className='pt-[128px] max-w-[1340px] m-auto max-md:pt-20'>
        ...
        <h1 className='font-normal text-[64px] leading-[100%] tracking-[-0.04em] mt-[32px] text-[#FFF] max-md:text-[32px] max-md:mt-6 max-md:leading-[100%]'>Контакты и расположение офиса</h1>
      </div>
    </div>
  )
}
