...
export default function AboutHero() {
  return (
    <div className='AboutHeader  h-[293px] mt-[44px]   '>
      <div className='pt-[128px] max-sm:ml-[16px] max-w-[1340px] m-auto'>
        ...
        <h1 className='font-normal text-[64px] leading-[100%] tracking-[-0.04em] max-sm:text-[32px] mt-[32px] text-[#FFF]'>О нас</h1>
      </div>
    </div>
  )
}
