...
export default function Compony2() {
  return (
    <div>
      ...
      <div className="mt-[48px] max-sm:ml-[16px] max-sm:mr-[16px] relative bg-[url('/sec10.png')] bg-cover bg-center h-[518px] max-w-[1340px] m-auto max-sm:rounded-[24px] rounded-[32px] overflow-hidden">
