  ...
  return (
    <div className='max-sm:ml-[16px] max-sm:mr-[16px] max-w-[1340px] m-auto mt-[100px] max-sm:flex-col  flex  justify-between max-md:mt-[40px]'>
      ...
      <div className='max-sm:w-[340px] w-[664px]'>
        <h2 className='font-normal mb-[16px] max-sm:text-[24px] text-[32px] leading-[32px] tracking-[-0.04em] max-md:leading-[30px] max-md:mb-4'>Genius Electro - ваш надёжный партнёр
