    ...
    <div className='max-w-[1340px] m-auto max-sm:ml-[16px] max-sm:mr-[16px] '>
      <div className='  mt-[100px]  flex max-sm:flex-col justify-between max-md:mt-[50px]'>
        ...
        <div className='w-[470px] max-md:w-full'>
          <h2 className='font-normal mb-[24px] text-[32px] leading-[42px] tracking-[-0.04em] max-sm:text-[24px] max-md:mb-4 max-md:leading-[30px] max-md:mt-6'>Поставки кабельной  продукции по всей России</h2>
