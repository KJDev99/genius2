...
export default function Footer() {
  return (
    <footer className="border-t border-[#2727271A] mt-[120px]">
      <div className="max-w-[1340px] mx-auto px-4 py-[48px] flex justify-between items-start">
      ...
      <div className="max-w-[1340px] mx-auto px-4 py-[82px] grid grid-cols-5 gap-10">
        <div>
          <Image
      ...
      <div className="max-w-[1340px] mx-auto px-4 pb-[64px] flex justify-between text-sm text-[#27272799]">
