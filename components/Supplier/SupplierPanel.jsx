...
export default function SupplierPanel({ setStep }) {
    ...
    const menuItems = [
        { label: 'Дэшборд', href: '/supplier/dashboard' },
        { label: 'Личные данные', href: '/supplier/user-info' },
        { label: 'Товары', href: '/supplier/product' },
        { label: 'Заказы', href: '/supplier/order' },
        { label: 'Финансы', href: '/supplier/binance' },
        { label: 'Настройки', href: '/supplier/settings' },
    ];
                        ...
                        <AnimatePresence initial={false}>
                            {isOpen && (
                                <motion.div
                                    ...
                                    animate="open"
                                    exit="closed"
                                    className="flex flex-col gap-[22px] mt-4 overflow-hidden max-md:mt-2"
                                >
